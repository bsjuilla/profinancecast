...
//
// Free on Vercel Hobby (Edge runtime). No build step required — Vercel
// auto-detects @vercel/og as a dependency from this import.
//
// USAGE:
...
//
// Brand: deep emerald canvas, gold eyebrow (Cormorant italic), big
// Cormorant italic title, Inter subtitle, gold-on-emerald PF logo.
...
export default function handler(req: Request) {
  ...
  return new ImageResponse(
    (
      ...
      >
        {/* Faint gold hairline at top — brand accent */}
        <div
          style={{
            position: 'absolute',
            top: 0,
        ...
        {/* Title — Cormorant italic feel via 'serif' fallback */}
        <div
          style={{
            display: 'flex',
