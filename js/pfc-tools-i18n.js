...
window.PFC_TOOLS_I18N = {
  global: {
    ...
    workedExample: 'A $10,000 starting balance plus $500/month at 7% for 30 years grows to roughly $691,000 — about $500,000 of which is compound growth, not contributions.',
  ...
  uk: {
    ...
    workedExample: 'A £10,000 ISA balance plus £500/month at 7% for 25 years compounds to roughly £462,000 — entirely tax-free because growth inside an ISA escapes capital gains and dividend tax.',
  ...
  ie: {
    ...
    workedExample: 'A €10,000 PRSA balance plus €500/month at 7% for 25 years grows to about €462,000 — but Irish exit tax on non-pension fund growth (currently 41%) can take a sizeable bite if held outside a pension.',
  ...
  fr: {
    ...
    workedExample: '10 000 € sur un PEA plus 500 €/mois à 7 % sur 25 ans donnent environ 462 000 € — exonérés d\'impôt sur le revenu après 5 ans de détention (seuls les prélèvements sociaux de 17,2 % restent dus).',
  ...
  de: {
    ...
    workedExample: '10.000 € Startkapital plus 500 €/Monat zu 7 % über 25 Jahre wächst auf ca. 462.000 € — davon werden in einem ETF-Sparplan etwa 26,375 % Abgeltungsteuer (inkl. Soli) auf realisierte Gewinne fällig.',
  ...
  us: {
    ...
    workedExample: 'A $10,000 Roth IRA balance plus $500/month at 7% for 30 years compounds to roughly $691,000 — all of which is tax-free at withdrawal after age 59½, because Roth contributions were made post-tax.',
